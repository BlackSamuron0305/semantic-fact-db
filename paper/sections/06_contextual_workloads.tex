...
Section~\ref{sec:evaluation} reports the per-workload speedup and equivalence
status.  The results are interpreted through a LOOKUP/GLOBAL classification:
workloads C1--C4 and C7 are primarily LOOKUP (stalk-indexed, where SheafDB
exhibits its strongest advantage); C5--C6 are temporal range queries with
mixed characteristics; C8--C10 involve GLOBAL scans where the KG baseline
achieves parity or advantage.
