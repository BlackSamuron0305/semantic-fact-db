...
uv run python scripts/lubm_external_reference.py --store jena  # LUBM vs. Jena
...
uv run python scripts/lubm_external_reference.py --store virtuoso  # LUBM vs. Virtuoso
...
uv run python scripts/lubm_external_reference.py --store graphdb  # LUBM vs. GraphDB
