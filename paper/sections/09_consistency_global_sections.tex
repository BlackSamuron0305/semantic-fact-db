...
The measured overhead of SheafDB's consistency checking (C8) and global section construction (C9) appears in Section~\ref{sec:evaluation}. Complexity analysis for the CSP baseline is given in Section~\ref{sec:complexity}.
\endinput
